...
--==ver0.0.0.5==--
 - Расширена система сохранения на интерактивные объекты на сцене;
 - Добавлены Pushable-объекты;
 - Добавлена Beam-головоломка;
 - Первичная реализация объектов Платформа;
 - Добавлена Тестовая сцена #1;
